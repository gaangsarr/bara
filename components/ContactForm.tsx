  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-2xl mx-auto space-y-6">
      ...
      <button
        type="submit"
        disabled={isPending}
        className="w-full bg-[#005792] text-white py-3 px-6 rounded-lg font-medium hover:bg-[#013d65] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors"
      >
        {isPending ? (
